...
<section id="ContenuPageMenuChic">
   <div id="hautdepagemenu">
        ...
        <div class="contenaireTitre-detailPageMenuSeul">
            ...
            <div class="contenaireTitre-detailPageMenuSeul">
                <p class="element-detailPageMenuSeul">Tartare de poulpe acidulé aux zests d'orange</p>
                <p class="element-detailPageMenuSeul">79€</p> 
                <p class="element-detailPageMenuSeul">Velouté de légumes d' antan</p>
        ...
        <div class="contenaireTitre-detailPageMenuSeul">
            ...
            <div class="contenaireTitre-detailPageMenuSeul">
                <p class="element-detailPageMenuSeul">Coquilles Saint- Jacques accompagnées d'une purée de panais</p>
                <p class="element-detailPageMenuSeul">95€</p> 
                <p class="element-detailPageMenuSeul">Magret de canard et parmentier de pommes de terres</p>
        ...
        <div class="contenaireTitre-detailPageMenuSeul">
            ...
            <div class="contenaireTitre-detailPageMenuSeul">
                <p class="element3-detailPageMenuSeul">Pétales de violettes glacés et purée de noisettes</p> 
